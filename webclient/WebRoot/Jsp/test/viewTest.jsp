...
<%System.out.println("In test"); %>
			<c:choose>
				<c:when test="${!empty model.allCustomeTestQuestion}">
					...
					<aa:zone name="myTable">
						...
						<display:table name="model.allCustomeTestQuestion" class="table"
							requestURI="viewTest.html?action=list" id="customeTestQuestion" export="false"
							excludedParams="*" pagesize="10" sort="list">

							<display:column  title="customeTestQuestionId" >
							<a href="question.html?id=<c:out value="${customeTestQuestion.questionId}"/>"><c:out value="${i+1}"/></a>
<c:set var="i" value="${i+1}"></c:set>
							...
							<display:column sortProperty="questionId" sortable="true"
								...
								<c:out value='${customeTestQuestion.questionBank.question}' />
							</display:column>
							...
							<display:column sortProperty="questionId" sortable="true"
								...
								<c:out value='${customeTestQuestion.questionBank.answerBank.choice}' />
							</display:column>
